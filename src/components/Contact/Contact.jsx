        ...
        <div className="flex md:flex-row flex-col justify-between items-center mx-auto max-w-5xl gap-6 ">
          ...
          <div className="right">
            ...
            <div className='mt-6'>
              ...
              <p className='text-white my-2'><i className="mr-1 fa-regular fa-envelope text-white p-2 rounded-[50%] hover:scale-110 bg-[#945d34]"></i> mennaabdelateef910@gmail.com</p>
              <p className='text-white my-2'><i className="mr-1 fa-solid fa-phone text-white p-2 rounded-[50%] hover:scale-110 bg-[#945d34]"></i> +20 01119121377</p>
            </div>
